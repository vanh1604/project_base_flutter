...
import '../widgets/stats/stats_bloc.dart';
import '../widgets/stats/stats_event.dart';
import '../widgets/stats/stats_state.dart';
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    child: _StatCard(
                                      title: 'Avg Pages',
                                      value: state.averagePages.toStringAsFixed(
                                        0,
                                      ),
                                  ...
                                  Expanded(
                                    child: _StatCard(
                                      title: 'Year Range',
                                      value:
                                          '${state.oldestYear}-${state.newestYear}',
                  ...
                  BlocBuilder<BooksBloc, BooksState>(
                    builder: (context, state) {
                      if (state is BooksLoading) {
                        return const Padding(
                          padding: EdgeInsets.all(32),
                          child: LoadingIndicator(message: 'Loading books...'),
                        );
                        ...
                        return ErrorWidgetCustom(
                          message: state.message,
                          onRetry: () => context.read<BooksBloc>().add(
